...
namespace TestFramework
{
    class Order
    {
        ...
        public bool addCus(string phone, string name, string address)
        {
            SqlCommand command = new SqlCommand("insert into Customer Values (@phone, @name, @address) ", mydb.GetConnection);
